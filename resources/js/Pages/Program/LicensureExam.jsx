    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                            ...
                            data.data.map((student, index) => (
                                ...
                                >
                                    ...
                                    <td className="py-3 px-6 text-center">
                                        <span
                                            className={`px-2 py-1 rounded-full text-xs font-bold uppercase ${student.status === "Passed" ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                                        >
                                            {student.status}
                                        </span>
                                    </td>
                                    ...
                                    {/* First Attempt */}
                                    <td className="py-3 px-6 text-center text-gray-700 font-bold">
                                        {student.first_attempt}
                                    </td>
                                </tr>
                            ))
                        ) : (
                ...
                {/* 1. Filter Modal: Force Batch Mode */}
                <FilterStudentModal
                ...
                {/* 2. Change Metric: Program Metrics */}
                <ChangeMetricModal
