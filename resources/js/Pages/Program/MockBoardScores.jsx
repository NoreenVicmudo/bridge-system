...
import { useMockInertia, MOCK_STUDENTS_MOCK_SCORES, MOCK_MOCK_SUBJECTS } from "@/Hooks/useMockInertia";
...
export default function MockExamScoresPage({ students }) {
    ...
    const subjectHeaders = isBackendReady ? students.subjects : MOCK_MOCK_SUBJECTS;
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                ...
                <ChangeMetricModal isOpen={isMetricModalOpen} onClose={() => setIsMetricModalOpen(false)} currentMetric="Mock Exam Scores" type="program" />
