...
export default function ReviewCenterPage({ students }) {
    ...
    // Active Filters - BATCH MODE DEFAULT
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                ...
                <FilterStudentModal
                    ...
                    allowSection={false} // <--- Disable section mode
                    defaultMode="batch" // <--- Start in batch mode
                />
                ...
                <ChangeMetricModal
                    ...
                    currentMetric="Review Center"
                    type="program" // <--- Shows Program Metrics list
                />
