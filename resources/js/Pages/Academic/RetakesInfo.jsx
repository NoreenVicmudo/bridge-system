...
import {
    useMockInertia,
    MOCK_STUDENTS_RETAKES,
    MOCK_RETAKE_SUBJECTS,
...
// SortableHeader Component (Local)
...
export default function RetakesInfoPage({ students }) {
    ...
    // Active Filters (Matches screenshot context)
    ...
    // Dynamic Subjects List (Mock or Backend)
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                                ...
                                >
                                    ...
                                    {subjectHeaders.map((subject, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <span
                                                    className={`font-bold ${value > 0 ? "text-red-500" : "text-gray-600"}`}
                                                >
                                                    {value}
                                                </span>
                                            </td>
                ...
                <ChangeMetricModal
                    ...
                    currentMetric="Back Subjects/Retakes"
                />
