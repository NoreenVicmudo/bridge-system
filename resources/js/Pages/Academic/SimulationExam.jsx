...
import {
    useMockInertia,
    MOCK_STUDENTS_SIMULATION,
    MOCK_SIMULATION_EXAMS,
...
export default function SimulationExamPage({ students }) {
    ...
    // Dynamic Simulation Headers (Mock or Backend)
    const simHeaders = isBackendReady
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                ...
                >
                    ...
                    <thead>
                        <tr className="bg-[#5c297c] text-white text-sm uppercase leading-normal">
                            ...
                            {/* Dynamic Simulation Headers */}
                            {simHeaders.map((header, i) => (
                                <th
                                    key={i}
                                    ...
                                    {simHeaders.map((header, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {value ? (
                                                    <span
                                                        className={`font-bold ${parseInt(value) < 75 ? "text-red-500" : "text-[#5c297c]"}`}
                                                    >
                                                        {value}
                                                    </span>
                                                ) : (
                ...
                <ChangeMetricModal
                    ...
                    currentMetric="Simulation Exam Results" // Pre-selects this in the modal
                />
