...
export default function PerformanceRatingPage({ students }) {
    ...
    // Dynamic Category Headers (Mock or Backend)
    // Matches PHP: foreach ($ratings as $ratingName)
    const ratingHeaders = isBackendReady
        ? students.categories
        : MOCK_PERFORMANCE_CATEGORIES;
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                ...
                >
                    ...
                    <thead>
                        <tr className="bg-[#5c297c] text-white text-sm uppercase leading-normal">
                            ...
                            {/* Dynamic Rating Category Headers */}
                            {ratingHeaders.map((header, i) => (
                                <th
                                    key={i}
                    ...
                    <tbody className="text-gray-600 text-sm font-medium">
                        {data.data.length > 0 ? (
                                    ...
                                    {ratingHeaders.map((header, i) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {value ? (
                                                    <span
                                                        className={`font-bold ${parseFloat(value) < 75 ? "text-red-500" : "text-[#5c297c]"}`}
                                                    >
                                                        {value}
                                                    </span>
                                                ) : (
                            ...
                            <tr>
                                <td
                                    colSpan={ratingHeaders.length + 2}
                ...
                <ChangeMetricModal
                    ...
                    currentMetric="Performance Rating" // Pre-selects this in the modal
                />
