...
import { useMockInertia, MOCK_STUDENTS_RECOGNITION } from "@/Hooks/useMockInertia";
...
export default function AcademicRecognitionPage({ students }) {
    const isBackendReady = !!students;
    const mock = useMockInertia(MOCK_STUDENTS_RECOGNITION);
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                ...
                >
                    <thead>
                        <tr className="bg-[#5c297c] text-white text-sm uppercase leading-normal">
                            ...
                            <SortableHeader label="Dean's List" sortKey="recognition_count" currentSort={sortColumn} currentDirection={sortDirection} onSort={handleSort} className="text-center" />
                        </tr>
                    </thead>
                ...
                <ChangeMetricModal isOpen={isMetricModalOpen} onClose={() => setIsMetricModalOpen(false)} currentMetric="Academic Recognition" />
