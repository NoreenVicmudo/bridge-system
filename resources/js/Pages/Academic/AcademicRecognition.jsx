        ...
        <AuthenticatedLayout>
            ...
            <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
                        ...
                        {data.data.length > 0 ? (
                            data.data.map((student, index) => (
                                ...
                                >
                                    ...
                                    {/* Recognition Count (Numeric) */}
                                    <td className="py-3 px-6 text-center">
                                        <span className="text-gray-700 font-bold text-base">
                                            {student.recognition_count > 0
                                                ? student.recognition_count
                                                : "-"}
                                        </span>
                                    </td>
                                </tr>
                ...
                <ChangeMetricModal
                    ...
                    currentMetric="Academic Recognition"
                />
