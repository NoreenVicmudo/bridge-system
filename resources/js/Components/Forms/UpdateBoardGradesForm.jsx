...
export default function UpdateBoardGradesForm({
    ...
    submit,
    studentName,
    subjectOptions = [], // All possible board subjects
    currentGrades = {}, // Existing grades: { subject_id: grade }
}) {
            ...
            <div className="w-full max-w-2xl bg-white rounded-[10px] shadow-[0_6px_25px_rgba(0,0,0,0.1)] px-6 py-4 md:px-8 md:py-5 flex flex-col max-h-full my-2 relative">
                ...
                <div className="overflow-y-auto overflow-x-hidden pr-2 flex-1 custom-form-scrollbar">
                    ...
                    >
                        ...
                        {/* Overview Section: Current Grades */}
                        <div className="border-t border-gray-100 pt-3">
                            <label className={labelClass}>
                                Board Subjects Overview:
                            </label>
                            <div className="space-y-2 mt-2">
                                {subjectOptions.length > 0 ? (
                                    subjectOptions.map((sub) => (
                                        ...
                                        >
                                            ...
                                            <input
                                                type="text"
                                                value={
                                                    currentGrades[sub.value] ||
                                                    "N/A"
                                                }
                                                className={`${inputClass} font-bold text-center w-24 bg-gray-50 border-gray-200 ${!currentGrades[sub.value] ? "text-gray-300" : ""}`}
                                                readOnly
                                            />
                                        </div>
                                    ))
                                    ...
                                    <p className="text-gray-400 italic text-sm py-2 text-center">
                                        No board subjects mapped to this
                                        program.
                                    </p>
                                )}
                            </div>
                        ...
                        <div className="border-t border-gray-100 pt-4 bg-purple-50/30 p-3 rounded-lg mt-1">
                            ...
                            <div className="mt-3 w-full">
                                ...
                                <TextInput
                                    ...
                                    onChange={(e) =>
                                        setData("subject_grade", e.target.value)
                                    }
                                    className={inputClass}
                                    required
                                />
                                {errors.subject_grade && (
                ...
                <ConfirmSaveModal
                    ...
                    message={
                        <>
                            Are you sure you want to update the board subject
                            grade for <br />
