...
export default function UpdateRetakesForm({
    ...
    submit,
    studentName,
    subjectOptions = [], // General subjects list: [{ value, label }]
    currentRetakes = {}, // Existing data: { general_subject_id: terms_repeated }
}) {
        ...
        <div className="flex justify-center w-full px-4 py-0 h-[calc(100vh-100px)] items-start overflow-hidden font-montserrat text-left text-[#5c297c]">
            <div className="w-full max-w-2xl bg-white rounded-[10px] shadow-[0_6px_25px_rgba(0,0,0,0.1)] px-6 py-4 md:px-8 md:py-5 flex flex-col max-h-full my-2 relative">
                <h2 className="text-center text-xl md:text-2xl font-bold mb-3 flex-shrink-0">
                    Student Back Subjects / Retakes Overview
                </h2>
                                    ...
                                    subjectOptions.map((sub) => (
                                        ...
                                        >
                                            ...
                                            <input
                                                type="text"
                                                value={
                                                    currentRetakes[sub.value] ??
                                                    "0"
                                                }
                                                className={`${inputClass} font-bold text-center w-24 bg-gray-50 border-gray-200 ${!currentRetakes[sub.value] ? "text-gray-300" : ""}`}
                                                readOnly
                                            />
                                        </div>
                                    ))
                ...
                <ConfirmSaveModal
                    ...
                    message={
                        <>
                            Are you sure you want to update the retake records
                            for <br />
