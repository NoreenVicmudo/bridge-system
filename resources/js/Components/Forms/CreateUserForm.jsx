...
export default function CreateUserForm({
    ...
    const isCollegeRequired = data.level !== "0"; // Everyone needs a college EXCEPT Super Admins
    const isProgramRequired = data.level === "3"; // ONLY Program Heads need a program
    ...
    const isFormValid =
        ...
        data.password.trim() !== "" &&
        data.level !== "" &&
        (!isCollegeRequired || data.college_id !== "") &&
        (!isProgramRequired || data.program_id !== "");
        ...
        <div className="flex justify-center w-full px-4 py-0 h-[calc(100vh-100px)] items-start overflow-hidden font-montserrat text-left text-[#5c297c]">
            <div className="w-full max-w-2xl bg-white rounded-[10px] shadow-[0_6px_25px_rgba(0,0,0,0.1)] px-6 py-4 md:px-8 md:py-5 flex flex-col max-h-full my-2 relative">
                    ...
                    >
                        ...
                        <div className="bg-purple-50/30 p-4 rounded-lg border border-purple-100/50 space-y-4">
                            ...
                            <div className="space-y-3">
                                <CustomSelectGroup
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setData(prev => ({
                                            ...prev,
                                            level: newLevel,
                                            // Reset college if they become a Super Admin
                                            college_id: newLevel === "0" ? "" : prev.college_id,
                                            // Reset program if they aren't a Program Head
                                            program_id: newLevel !== "3" ? "" : prev.program_id
                                        }));
                                    }}
                                ...
                                {/* Hide College selection for Super Admins */}
                                {isCollegeRequired && (
                                ...
                                {/* Only show Program selection for Program Heads */}
                                {isProgramRequired && (
                                    <div className="animate-fade-in-up">
                                        <CustomSelectGroup
                ...
                <ConfirmSaveModal
                    ...
                    message={
                        <>
                            Are you sure you want to create a new account for <br />
