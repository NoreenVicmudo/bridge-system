        ...
        <div className={`fixed inset-0 z-[1000] flex items-center justify-center transition-all duration-300 ${animate ? "bg-gray-900/60 backdrop-blur-sm" : "bg-transparent backdrop-blur-none pointer-events-none"}`}>
            <div className={`bg-white rounded-2xl w-[90%] max-w-[500px] shadow-2xl relative overflow-hidden transition-all duration-300 transform ${animate ? "scale-100 opacity-100" : "scale-95 opacity-0"}`}>
                ...
                <div className="bg-[#5c297c] p-6 text-center text-white relative">
                    ...
                    <p className="text-purple-200 text-sm mt-1">Import CSV or edit a student's review center</p>
                    ...
                    {view === "import" && (
                        <form onSubmit={handleImportSubmit} className="flex flex-col gap-4 animate-fade-in-up">
                            <div className="text-center mb-1">
                                <h3 className="font-bold text-[#5c297c] text-lg">Upload Review Center Data</h3>
                                <p className="text-xs text-gray-600 mt-1">
                                    Format: <strong>[Student ID]</strong>, <strong>[Name]</strong>, <strong>[Review Center]</strong>
                                </p>
                            </div>
                        ...
                        <div className="flex flex-col gap-5 animate-fade-in-up">
                            ...
                            {checkStatus === "not_exists" && (
                                <div className="flex items-center gap-2 p-3 bg-red-50 text-red-700 w-full justify-center rounded-lg border border-red-100 animate-fade-in">
                                    ...
                                    <span className="text-sm font-medium">Student not found in masterlist.</span>
                                </div>
                            )}
